...
const videoList = [
    ...
    { url: 'https://www.bk8myr.com/public/html/new_bk8/sponsorship/BK8%20Cup%20Malaysia%202019-Johor.mp4', sort: 'event' },
    { url: 'https://www.bk8myr.com/public/html/new_bk8/sponsorship/Bk8%20Cup%20Malaysia%202019-Penang.mp4', sort: 'event' },
    { url: 'https://www.bk8myr.com/public/html/new_bk8/sponsorship/BK8%20IDR%20CISCLampung%20Jersey%202018-2019.mp4', sort: 'sponsorship' },
]
function Video() {
        ...
        <div className={cx('video-wrapper')}>
            <div className={cx('tab-Video')}>
                {tabVideo.map((item, index) => (
                    <div className={cx('tab-Video__items',index === active ? 'active' : '')} key={index} onClick={() => { setTabRender(item.key) }}>
                        <button onClick={() => handleChangeTab(index, item.key)} className={cx("tab-Video__name")}>{item.display}</button>
                    </div>
                ))}
            </div>
