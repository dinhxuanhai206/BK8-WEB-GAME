...
import styles from "./Eth.module.scss";
        ...
        <div className={cx("qr-block")}>
          <div className={cx("qr-left")}>
            <div className={cx("img")}>
              <img src={images.ETHQR} alt="" className={cx("img-teraQR")} />
            </div>
          ...
          <div className={cx("qr-right")}>
            <div>
              <p className={cx("p1")}>Min Deposit = ETH 0.01</p>
              <p className={cx("p2")}>Current exchange rate</p>
              <p className={cx("p3")}>ETH 1 = MYR 4887.43358</p>
            </div>
        ...
        <div className={cx("address-block")}>
          <div className={cx("code-block")}>
            <div className={cx("code")}>
              0x88ac09a63c6c2961c8edfe25d1e1c8d
            </div>
