...
import styles from "./Tera.module.scss";
        ...
        <div className={cx("qr-block")}>
          <div className={cx("qr-left")}>
            <div className={cx("img")}>
              <img src={images.teraQR} alt="" className={cx("img-teraQR")} />
            </div>
          ...
          <div className={cx("qr-right")}>
            <div>
              <p className={cx("p1")}>Min Deposit = USDT 10</p>
              <p className={cx("p2")}>Current exchange rate</p>
              <p className={cx("p3")}>USDT 1 = MYR 4.38</p>
            </div>
            <div className={cx("p-bottom")}>
              <p className={cx("p4")}>CHAIN : TRC20</p>
      ...
      <div className={cx("send")}>
        ...
        <div className={cx("address-block")}>
          <div className={cx("code-block")}>
            <div className={cx("code")}>TEu3GG9Bu9koB42z7N1GKHSeCSgGq3N6Ez</div>
