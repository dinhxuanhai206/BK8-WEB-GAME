...
import styles from "./Btc.module.scss";
        ...
        <div className={cx("qr-block")}>
          <div className={cx("qr-left")}>
            <div className={cx("img")}>
              <img src={images.BTCQR} alt="" className={cx("img-teraQR")} />
            </div>
          ...
          <div className={cx("qr-right")}>
            <div>
              <p className={cx("p1")}>Min Deposit = BTC 0.005</p>
              <p className={cx("p2")}>Current exchange rate</p>
              <p className={cx("p3")}>BTC 1 = MYR 89357.122</p>
            </div>
      ...
      <div className={cx("send")}>
        ...
        <div className={cx("address-block")}>
          <div className={cx("code-block")}>
            <div className={cx("code")}>15zUg2hz8sdCXcfBMueoisGM1Q6KrNCJb9</div>
